...
export const WHATSAPP_URL = `https://wa.me/${PHONE_RAW}?text=${encodeURIComponent('Hi Digi Hooks! I would like to discuss growing my business online.')}`
...
export const REVIEWS = [
  {
    ...
    rating: 5,
    text: 'Digi Hooks rebuilt our website and within two months we started getting enquiries from Google. Clear communication and no fluff, exactly what we needed.',
  },
  {
    name: 'Priya Sharma',
    role: 'Founder',
    ...
    rating: 5,
    text: 'Our Google Business Profile was barely visible before. They optimized everything and now we show up in local searches. Bookings have doubled.',
  },
  {
    name: 'Amit Patel',
    role: 'Director',
    business: 'Patel Engineering',
    rating: 5,
...
export const CHALLENGES = [
  ...
  },
  {
    ...
    solution:
      'Digi Hooks designs funnel aligned campaigns with landing pages, offers, and tracking so every click has a purpose.',
  },
  {
    id: 'poor-visibility',
...
export const SERVICES = [
  {
    ...
    desc: 'High performance sites engineered for speed, SEO, and lead conversions not brochureware.',
    accent: 'from-purple/40 to-blue/20',
    icon: 'Code2',
  },
  {
    title: 'SEO Optimization',
    desc: 'Technical fixes, keyword strategy, and content that compound visibility month over month.',
    accent: 'from-blue/30 to-purple/25',
    icon: 'LineChart',
  },
  {
    title: 'Google Business Profile',
    desc: 'Dominate local search with optimized listings, reviews strategy, and map pack presence.',
    accent: 'from-orange/25 to-purple/20',
    icon: 'MapPin',
  },
  {
    title: 'Social Media Marketing',
    desc: 'Platform native content and paid amplification that builds authority and inbound demand.',
    accent: 'from-purple/30 to-orange/20',
    icon: 'Share2',
  },
  {
    title: 'Website Maintenance',
    desc: 'Updates, security, uptime, and performance monitoring so your site never becomes a liability.',
    accent: 'from-blue/25 to-orange/15',
    icon: 'Shield',
  },
] as const
